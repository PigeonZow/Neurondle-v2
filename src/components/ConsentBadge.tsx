...
export function ConsentBadge() {
  ...
  return (
    <button
      ...
      className="group fixed bottom-3 right-3 z-40 flex items-center gap-2 bg-game-surface/85 backdrop-blur-sm hover:bg-game-surface rounded-md pl-2 pr-2.5 py-1.5 ring-1 ring-white/5 hover:ring-white/10 transition-all pointer-events-auto shadow-lg"
    >
      ...
      <span className="text-[10px] font-mono text-gray-600 group-hover:text-gray-400 transition-colors hidden sm:inline">
        {shortId}
      </span>
    </button>
  )
